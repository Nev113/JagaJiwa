  ...
  return (
    <div>
      <div className="flex flex-row relative">
        <div className="flex flex-row items-center justify-center w-full h-[300px]">
          <div className="relative">
            <div className="p-1 px-2 backdrop-blur-xl rounded-full ring-3 ring-gray-600 absolute font-montserrat font-semibold text-[14px] -top-[9px] -left-[20px] text-gray-300">
              100% <span className="font-lora text-green-800">Mood</span>
            </div>
            <div className="p-1 px-2 backdrop-blur-sm rounded-full ring-3 ring-gray-600 absolute font-montserrat font-semibold text-[14px] -bottom-[9px] -right-[20px] text-gray-300">
          ...
          <div className="w-[400px] h-1 bg-gray-200"></div>
          <div className="relative">
            <div className="p-1 px-2 backdrop-blur-xl rounded-full ring-3 ring-gray-600 absolute font-montserrat font-semibold text-[14px] -top-[9px] -left-[20px] text-gray-300">
      ...
      <div className="flex flex-col gap-2 items-center justify-center -mt-5">
        <h1 className="text-3xl font-bold text-slate-100 mb-4 text-center font-montserrat">
          Raih Kembali Harapan
          <br />
          Bersama Kita Jaga Jiwamu
        </h1>
        <div className="p-3 px-4 ring-4 ring-red-400 bg-red-200 rounded-full font-lora text-red-800 text-2xl font-bold flex flex-row items-center justify-center gap-2">
      ...
      <div className="my-10">
        <div className="flex flex-row gap-5 justify-center items-center">
          <h1 className="font-montserrat font-bold text-[62px]">JAGA</h1>
          <div className="flex-col flex gap-1">
            <p className="font-lora font-semibold text-[32px]">Jiwa</p>
            <p className="font-lora font-semibold text-[32px] -mt-5 text-indigo-600">
              Finansial
            </p>
          </div>
        </div>
